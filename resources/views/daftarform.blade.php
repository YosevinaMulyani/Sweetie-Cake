...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#FFC0CB;">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a type="button" class="btn" style="background-color:white;  color:#DB7093;" href="/loginform">Login</a>
        </div>
    </div>
</nav>
...
<body>
    <div class="container" style="padding-top:50px;">
        <div class="row justify-content-center mt-5">
            <div class="col-md-4">
                <div class="card">
                    <h2 class="text-center" style="color:#DB7093;"> Daftar </h2>
                    ...
                    <div class="card-body">
                        <form method="post" action="daftar">
                            ...
                            <div class="form-group">
                                <input type="text-area" class="form-control" placeholder="Alamat" name="alamat">
                            </div>
                            <button type="submit" class="btn" style="background-color:#DB7093; color:white;">Daftar</button>
                        </form>
                    </div>
                </div>
            </div>
